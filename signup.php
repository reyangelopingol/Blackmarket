...
<html>
<head>
    <title>Register - BlackMarket</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body::before {
            ...
            width: 200%;
            height: 200%;
            background: radial-gradient(ellipse at 70% 30%, rgba(192,57,43,0.08) 0%, transparent 60%),
                        radial-gradient(ellipse at 30% 80%, rgba(192,57,43,0.05) 0%, transparent 50%);
    ...
    <div class="register-wrapper">
        <div class="register-box">
            <div class="logo-section">
                ...
                <div class="logo-sub">Join the Community</div>
            </div>
            
            <div class="register-title">Create Account</div>
            <div class="register-subtitle">Start shopping premium firearms</div>
